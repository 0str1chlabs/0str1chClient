...
export const InfiniteCanvas = ({ children, onAddSheet }: InfiniteCanvasProps) => {
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-black dark:to-neutral-900">
